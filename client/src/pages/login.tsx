        ...
        <div className="w-full md:w-1/2 p-8 flex flex-col justify-center items-center md:items-end">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">
              <span className="block">Your AI Speech</span>
              <span className="block bg-clip-text text-transparent bg-gradient-to-r from-primary-light to-secondary-light">Assistant</span>
            </h2>
            ...
            <div className="mt-8 space-y-4">
              <FeatureItem>Advanced Speech Recognition</FeatureItem>
              <FeatureItem>Natural Language Processing</FeatureItem>
              <FeatureItem>Voice Personalization</FeatureItem>
            </div>
          </motion.div>
        </div>
